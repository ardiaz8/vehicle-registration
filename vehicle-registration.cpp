...
void menu(void){
	...
	cout << "6) Buscar por el a�o de un vehiculo" 							 	 << endl;
	cout << "7) Buscar por propietario de un vehiculo"			 			 	 << endl;
	cout << "8) Ordenar los vehiculos en orden creciente por el a�o del vehiculo"<< endl;
...
void insertarInicio(void){
	...
	do {
		...
		cout << "A�o del vehiculo (entre 1950 y 2022)-->" << endl;
		cin >> nuevo->year;
		if(nuevo->year < 1950 || nuevo->year > 2022){
			cout << "A�o invalido" << endl;
			cin.ignore();
		}//if
...
void buscarFecha(void){
	...
	cout << "Ingresa el a�o del vehiculo a buscar--> ";
	cin >> targetYear;	
	cin.ignore();
	...
	cout << "El a�o " << targetYear << " no esta registrado en la lista" << endl;
	return;
}//buscar
...
//#8 Funcion para ordenar los vehiculos por su a�o en orden creciente
void ordenarPorYear(void){
	//Declarar apuntador
...
void respaldar(void){
	...
	while (copia != NULL){
		...
		archivoGuardar <<  "A�o: "				 				<< copia->year				<< endl;
